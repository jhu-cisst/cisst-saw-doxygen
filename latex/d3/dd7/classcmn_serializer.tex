...
\index{Type\+Id@{Type\+Id}!cmn\+Serializer@{cmn\+Serializer}}
...
\index{cmn\+Serializer@{cmn\+Serializer}!cmn\+Serializer@{cmn\+Serializer}}
...
\hline
\end{DoxyParams}
\hypertarget{classcmn_serializer_a02941ff3aaf78477e281c8510b8824c0}{}\index{cmn\+Serializer@{cmn\+Serializer}!````~cmn\+Serializer@{$\sim$cmn\+Serializer}}
\index{````~cmn\+Serializer@{$\sim$cmn\+Serializer}!cmn\+Serializer@{cmn\+Serializer}}
...
\index{Reset@{Reset}!cmn\+Serializer@{cmn\+Serializer}}
...
\index{Serialize@{Serialize}!cmn\+Serializer@{cmn\+Serializer}}
...
\index{Serialize\+Services@{Serialize\+Services}!cmn\+Serializer@{cmn\+Serializer}}
...
It is important to note that a regular user doesn\textquotesingle{}t need to use this method as the Serialize method performs this task. It is provided for advanced users who need or want to serialize all the class information first and then serialize their objects. This can be used to avoid time delays while serializing and de-\/serializing objects.
...
\index{Services\+Serialized@{Services\+Serialized}!cmn\+Serializer@{cmn\+Serializer}}
