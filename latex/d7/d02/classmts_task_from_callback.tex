...
The \hyperlink{classmts_task_from_callback}{mts\+Task\+From\+Callback} class can be used in all cases. The derived class must provide a callback function (e.\+g., a static function) and implement an alternate method to get the \textquotesingle{}this\textquotesingle{} pointer. The user-\/created callback function should call Run\+Internal and return the data (if any).
...
\index{Base\+Type@{Base\+Type}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
Create a task with name \textquotesingle{}name\textquotesingle{} and set the state table size. The execution of this task will rely on a callback from an external thread.
...
\end{DoxySeeAlso}
\hypertarget{classmts_task_from_callback_a6af1292436c5c06029742818a7be0eea}{}\index{mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}!````~mts\+Task\+From\+Callback@{$\sim$mts\+Task\+From\+Callback}}
\index{````~mts\+Task\+From\+Callback@{$\sim$mts\+Task\+From\+Callback}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Create@{Create}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Do\+Callback@{Do\+Callback}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Kill@{Kill}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Run\+Internal@{Run\+Internal}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Start@{Start}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Startup\+Internal@{Startup\+Internal}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{Suspend@{Suspend}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
...
\index{in\+Run\+Internal@{in\+Run\+Internal}!mts\+Task\+From\+Callback@{mts\+Task\+From\+Callback}}
